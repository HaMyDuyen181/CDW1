<x-layout-admin>
    ...
    <div class="container mx-auto p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div>
                <a href="{{ route('product.create') }}" class="bg-green-500 text-white px-4 py-2 rounded-md mr-2 hover:bg-green-600">Thêm sản phẩm</a>
                <a href="{{ route('product.trash') }}" class="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600">Thùng rác</a>
            </div>
        </div>
            ...
            <table class="min-w-full table-auto">
                ...
                <tbody>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-900">
                            <img src="{{ asset('/images/product/' . $item->thumbnail) }}" 
                                 alt="{{ $item->name }}" 
                                 class="rounded-md" 
                        ...
                        <td class="flex px-7 py-8 text-center">
                            ...
                            <!-- Xóa (Delete) -->
                            <form action="{{ route('product.delete', $item->id) }}" method="POST" class="inline-block">
                                @csrf
                                @method('DELETE')

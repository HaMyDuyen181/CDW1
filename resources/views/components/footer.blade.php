<div class="container mx-auto bg-red-200">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        ...
        <div>
            ...
            <a href="/gioi-thieu" class="text-red-500 text-sm hover:underline">Tìm hiểu thêm...</a>
        </div>
        ...
        <div>
            ...
            <div class="mt-4 flex space-x-4">
                <a href="#" class="text-black hover:text-lime-500"><i class="fab fa-facebook-f"></i></a>
                <a href="#" class="text-black hover:text-lime-500"><i class="fab fa-twitter"></i></a>
                <a href="#" class="text-black hover:text-lime-500"><i class="fab fa-instagram"></i></a>
                <a href="#" class="text-black hover:text-lime-500"><i class="fab fa-linkedin-in"></i></a>
            </div>
        </div>
    </div>

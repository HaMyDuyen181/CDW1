    ...
    <div class="flex flex-wrap">
        ...
        <div class="w-full md:w-1/2 pl-0 md:pl-8">
            <div class="product-information">
                ...
                <p class="mt-2 text-gray-700"><b>Thương hiệu:</b> {{ $product->brand->name }}</p>
                <p class="mt-2 text-gray-700"><b>Danh mục:</b> {{ $product->category->name }}</p>
                ...
                <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 px-4 mb-8">
                    <div class="product-item border rounded-lg shadow-md overflow-hidden">
                        <a href="{{ route('site.product.detail', ['slug' => $related_product->slug]) }}" class="block">
                            ...
                            <h4 class="text-lg font-semibold text-center text-gray-800">{{ $related_product->name }}</h4>
                            <p class="text-center text-gray-600 mt-2">${{ $related_product->price }}</p>
                        </a>
                    </div>
                </div>
            @endforeach

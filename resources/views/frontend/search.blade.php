          ...
          <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
              @foreach ($products as $product)
                  <div class="border rounded-lg shadow-lg p-4">
                      ...
                      <a href="{{ route('frontend.product-detail', $product->id) }}" class="block text-center bg-blue-600 text-white py-2 mt-3 rounded-lg hover:bg-blue-700 transition duration-300">Xem chi tiết</a>
                  </div>
              @endforeach
          </div>
